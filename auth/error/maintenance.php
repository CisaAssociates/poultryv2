<?php include emmet('partials.main.php') ?>

<head>
    <?php
    $title = "Maintenance | We'll be back shortly";
    include emmet('partials.title-meta.php') ?>

    <?php include emmet('partials.head-css.php') ?>
</head>
...
<body class="authentication-bg">
    ...
    <?php include emmet('partials.footer-scripts.php') ?>
